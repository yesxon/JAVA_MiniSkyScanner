...
public class timetable2 {
    ...
    public timetable2() {
        // 한국행 미국발 시간표 초기화
        usTimetable = new String[]{"08:35", "10:30", "12:10", "13:25", "16:40", "19:20", "22:20"  /* 추가 시간표들 */};
        usRemainingSeats = new int[]{82, 170, 132, 155, 115, 77, 30 /* 추가 좌석 수들 */};
        usPrices = new int[]{50000, 60000, 70000, 80000, 90000, 100000, 110000 /* 추가 가격들 */};
        // 한국행 베트남발 시간표 초기화
        vietnamTimetable =  new String[]{"08:50", "11:30", "14:40", "15:55", "18:30", "19:50", "21:20"  /* 추가 시간표들 */};
        vietnamRemainingSeats =  new int[]{40, 0, 142, 200, 140, 24, 15 /* 추가 좌석 수들 */};
        vietnamPrices =  new int[]{70000, 80000, 90000, 100000, 110000, 120000, 130000 /* 추가 가격들 */};
        // 한국행 이탈리아발 시간표 초기화
        italyTimetable =  new String[]{"09:15", "10:20", "12:00", "14:25", "17:30", "20:20", "23:50"  /* 추가 시간표들 */};
        italyRemainingSeats = new int[]{50, 100, 112, 55, 120, 44, 80 /* 추가 좌석 수들 */};
        italyPrices = new int[]{50000, 60000, 70000, 80000, 90000, 100000, 110000 /* 추가 가격들 */};
    }
